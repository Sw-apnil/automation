...
export async function getAccountRows() {
  ...
  return (data ?? []).map((account) => ({
    ...
    gnews_api_key: Boolean(account.gnews_api_key),
    guardian_api_key: Boolean(account.guardian_api_key),
